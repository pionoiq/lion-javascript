...
copiedObject = (object) => Object.assign({}, object);
const newObject = copiedObject(messenger);
// copydObject라는 함수는 오브젝트를 매개변수로 받고 오브젝트의 어싸인을 통해서 전달받은 오브젝트를 복사해서 값을 반환하는 함수다.
...
let copyedContainerStyle = { ...containerStyles };
