...
function first() {
  ...
  return second; // 작성된 환경을 기억하는 함수 본문 전체를 그대로 내보낸다
}
...
// counter()(); //1, 1, 1...
let result = counter(); // 1, 2, 3..
// incre가 result에 연결된 상태이기 때문에 가비지컬렉터가 let count를 수집해가지 않기 때문에 초기화되지 않음
